...
const resources = {
  en: {
    translation: {
      ...
      nav: { home: 'Knowledge Base', add: 'Add Knowledge', tags: 'Tags', plans: 'Plans', tokenConsumption: 'Token Consumption', stats: 'Statistics', statsKnowledge: 'Knowledge', statsPlans: 'Plans', settings: 'Settings', widgets: 'Widgets', quickStats: 'Quick Stats' },
  ...
  es: {
    translation: {
      ...
      nav: { home: 'Base de Conocimiento', add: 'Agregar Conocimiento', tags: 'Etiquetas', plans: 'Planes', tokenConsumption: 'Consumo de Tokens', stats: 'Estadísticas', statsKnowledge: 'Conocimiento', statsPlans: 'Planes', settings: 'Configuración', widgets: 'Widgets', quickStats: 'Estadísticas Rápidas' },
  ...
  pt: {
    translation: {
      ...
      nav: { home: 'Base de Conhecimento', add: 'Adicionar Conhecimento', tags: 'Tags', plans: 'Planos', tokenConsumption: 'Consumo de Tokens', stats: 'Estatísticas', statsKnowledge: 'Conhecimento', statsPlans: 'Planos', settings: 'Configurações', widgets: 'Widgets', quickStats: 'Estatísticas Rápidas' },
