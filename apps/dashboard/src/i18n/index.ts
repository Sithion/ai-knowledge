...
const resources = {
  en: {
    translation: {
      ...
      planFile: { preview: 'Preview', openInEditor: 'Open in editor', copyPath: 'Copy path', truncated: 'Preview truncated — file is larger than 256 KB.', notFound: 'File not found.', unsupported: 'Opening files is not supported on this platform.' },
  ...
  es: {
    translation: {
      ...
      planFile: { preview: 'Vista previa', openInEditor: 'Abrir en editor', copyPath: 'Copiar ruta', truncated: 'Vista previa truncada — el archivo supera 256 KB.', notFound: 'Archivo no encontrado.', unsupported: 'Abrir archivos no es compatible en esta plataforma.' },
  ...
  pt: {
    translation: {
      ...
      planFile: { preview: 'Pré-visualização', openInEditor: 'Abrir no editor', copyPath: 'Copiar caminho', truncated: 'Pré-visualização truncada — o arquivo é maior que 256 KB.', notFound: 'Arquivo não encontrado.', unsupported: 'Abrir arquivos não é suportado nesta plataforma.' },
